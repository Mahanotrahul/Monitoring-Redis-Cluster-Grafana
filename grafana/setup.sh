...
echo "Running configure_grafana in the background... Dashboards and datasources might not install properly due to some error. If you face any such issues, you can import manually from the garana wesbite"
configure_grafana &
/run.sh
exit 0
